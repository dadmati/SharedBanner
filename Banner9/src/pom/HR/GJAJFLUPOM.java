...
public class GJAJFLUPOM {
	 ...
	 */
	public GJAJFLUPOM(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void importFileToJobSubServer(String fileNames) throws Exception {
     //Add comments on who created the method and what it does.
		...
		for (WebElement element : elements) {
		    if (element.getAttribute("type").equals("image")) {
		        System.out.println("Output is = "+element.getAttribute("title"));
		    }
		}*/
		
		
		
		WebElement getValue = (new WebDriverWait(driver, 120))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='#gjrjfluFileName']")));
		Thread.sleep(5000);

		
		String file = driver.findElement(By.xpath("//*[@id='#gjrjfluFileName']")).getAttribute("title");
		//String file = driver.findElement(By.xpath("//*[@id='#gjrjfluFileName']")).getAttribute("innerHTML");
		
		 //driver.findElement(By.xpath("//*[@id='#gjrjfluFileName']"));
		// driver.getPageSource().contains("GOPayroll.csv");  
		//driver.findElement(By.xpath("//*[@id='#gjrjfluFileName']"));
		//driver.findElement(By.xpath("//*[@id='#gjrjfluFileName']"));
		
		//String file = driver.findElement(By.xpath("//*[@class='ui-widget-content ui-corner-all']")).getAttribute("value");

		//<input type="text" id="#gjrjfluFileName" name="gjrjfluFileName" style="width: 420px; " class="ui-widget-content ui-corner-all" autocomplete="off" maxlength="30" dir="ltr" title="GOPayroll.csv" readonly="readonly" aria-required="true">
		System.out.println("field value = "+file);
		//if(file.isEmpty())
		if(driver.getPageSource().contains("GOPayroll.csv")||driver.getPageSource().contains("BWPayroll.csv"))
	...
	/*		del.until(ExpectedConditions
			...
			delete.moveToElement(driver.findElement(By.xpath(".//*[@class='hidden-xs'][contains(text(),'Delete')]")));
			Thread.sleep(2000);
			delete.click();
			Thread.sleep(2000);
			...
			//<p class="notifications-item-text">Saved successfully (1 rows saved)</p>
			//driver.findElement(By.xpath(".//*[@class='notifications-item-text'][contains(text(),'Saved successfully')]"));
			if(driver.findElement(By.xpath(".//*[@class='notifications-item-text'][contains(text(),'Saved successfully')]")).isDisplayed())
				  
			{
				System.out.println("Save is present");
			...
			{
				System.out.println("Save is NOT present");
			}	
...
*/		
	     ...
	     actions.moveToElement(driver.findElement(By.xpath("//*[@class='ui-buttoninput ui-button ui-widget ui-state-default ui-button-icon-only ui-corner-right ui-button-icon']")));
	     actions.click();
	...
	*/		
			...
			WebElement Username = (new WebDriverWait(driver, 120))
					.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@class='notifications-item-text'][contains(text(),'Saved successfully (1 rows saved)')]")));
			driver.findElement(By.xpath(".//*[@class='notifications-item-text'][contains(text(),'Sa`ved successfully (1 rows saved)')]"));
