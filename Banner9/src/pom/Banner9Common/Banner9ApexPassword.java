...
public class Banner9ApexPassword {
	// @Test
	 ...
	 * 
	 */
	public Banner9ApexPassword(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void newPassword(String newPW1, String newPW2, String message) throws Exception
	{
		...
		WebElement confirmPageHeaderInfo0 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'Microsoft Access Banner Password Reset')]")));
		WebElement confirmPageHeaderInfo1 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'Password Requirements')]")));
    	WebElement confirmPageHeaderInfo2 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'Password must be 8 characters minimum')]")));
		WebElement confirmPageHeaderInfo3 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'Password must contain at least 3 of upper/lower/numeric/special ')]")));
		WebElement confirmPageHeaderInfo4 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'A person can only change their password once per day ')]")));
		WebElement confirmPageHeaderInfo5 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'Password cannot be one of the 10 last used passwords')]")));
		WebElement confirmPageHeaderInfo6 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'Password cannot contain their username or display name.')]")));
		
		
		WebElement confirmPageHeaderInfo7 = (new WebDriverWait(driver, 60))
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@class='t-Form-label'][contains(text(),'New password')]")));
		
		
		WebElement confirmPageHeaderInfo8 = (new WebDriverWait(driver, 60))
		.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@class='t-Form-label'][contains(text(),'Confirm password')]")));
	
		
		WebElement confirmPageHeaderInfo9 = (new WebDriverWait(driver, 60))
		.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[contains(text(),'This will reset your password for: Microsoft Access, Spreadsheet Budgeting and Bosscars')]")));
