...
public class Banner9CommonCopy {
	// @Test
	 ...
	 */
	public Banner9CommonCopy(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void clickCopy() throws Exception{
		...
		WebElement sourcecode = (new WebDriverWait(driver, 60)).until(ExpectedConditions
				.elementToBeClickable(By.xpath(".//*[@class='hidden-xs'][contains(text(),'Copy')]")));
			
		 Actions actions = new Actions(driver);
	     actions.moveToElement(driver.findElement(By.xpath(".//*[@class='hidden-xs'][contains(text(),'Copy')]")));
	     Thread.sleep(3000);
	     actions.click();
	     Thread.sleep(3000);
